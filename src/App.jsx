...
const speakers = [
  {
    ...
    role: 'AEIOU Solution',
    bio: 'กลยุทธ์การตลาดและ AI ที่ใช้ได้จริงสำหรับธุรกิจยุคใหม่',
    image: '/speakers/speaker-an.png?v=3',
    accent: 'from-rose-500 to-orange-400',
  },
  {
    ...
    bio: 'สาย TikTok การตลาดคอนเทนต์ และระบบปิดการขายที่โตไว',
    image: '/speakers/speaker-saran.png?v=3',
    accent: 'from-sky-500 to-cyan-400',
  },
  {
    name: 'ดร.กฤตินี พงษ์ธนเลิศ (อ.เกตุ)',
    role: 'เกตุวดี Marumura',
    bio: 'ปรัชญาการตลาดสไตล์ญี่ปุ่นที่เน้นความจริงใจ สร้างคุณค่าที่ยั่งยืน',
    image: '/speakers/speaker-kritinee.png?v=3',
    accent: 'from-violet-500 to-fuchsia-400',
  },
  {
    ...
    image: '/speakers/speaker-kris.png?v=3',
  ...
  },
  {
    ...
    image: '/speakers/speaker-pong.png?v=3',
  ...
  },
  {
    ...
    image: '/speakers/speaker-ice.png?v=3',
  ...
  },
  {
    ...
    image: '/speakers/speaker-mod.png?v=3',
  ...
  },
  {
    ...
    image: '/speakers/speaker-sun.png?v=3',
  ...
  },
  {
    ...
    image: '/speakers/speaker-pop.png?v=3',
