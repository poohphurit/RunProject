          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-200/80 p-8 md:p-12 text-center shadow-[0_20px_50px_rgba(15,23,42,0.03)] hover:shadow-[0_30px_70px_rgba(244,63,94,0.06)] hover:-translate-y-1 transition duration-300">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-5 text-center items-stretch border-t border-slate-100 pt-10">
                ...
                {/* 5. Line & Socials */}
                <div className="group/item flex flex-col items-center text-center p-6 rounded-3xl bg-slate-50/40 border border-slate-100 hover:bg-rose-50/30 hover:border-rose-100/80 hover:shadow-lg hover:shadow-rose-100/20 transition-all duration-300 h-full">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#00C300]/10 border border-[#00C300]/30 text-[#00C300] mb-4 shadow-sm transition-transform duration-300 group-hover/item:scale-110">
                    <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M19.365 9.863c.349 0 .63.285.63.631 0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63 0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63h2.386c.346 0 .627.285.627.63 0 .349-.281.63-.63.63H17.61v1.125h1.755zm-3.855 3.016c0 .26-.166.487-.393.585-.077.033-.163.049-.248.049-.138 0-.275-.043-.388-.124l-2.395-1.748v1.606c0 .344-.282.629-.631.629-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63.262 0 .491.168.588.397.033.073.048.156.048.241 0 .135-.042.268-.122.38l-2.396 1.746V8.108c0-.345.282-.63.63-.63.345 0 .629.285.629.63v4.771zm-5.972-.534c0 .344-.282.629-.631.629-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63.346 0 .628.285.628.63v4.771zm-2.466.534c0 .344-.282.629-.631.629H4.056c-.346 0-.628-.285-.628-.629V8.108c0-.345.282-.63.63-.63.345 0 .629.285.629.63v3.513h1.754c.345 0 .628.285.628.63C7.072 12.879 7.072 12.879 7.072 12.879zM12 0C5.373 0 0 4.298 0 9.601c0 4.794 3.758 8.87 9.096 9.539.313.064.721.196.828.455.097.234.062.593.03.824l-.128.802c-.039.231-.186.918.814.498.995-.417 5.373-3.176 7.375-5.467C21.432 13.916 24 11.916 24 9.601 24 4.298 18.627 0 12 0z"/>
                    </svg>
                  </div>
